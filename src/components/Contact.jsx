            ...
            <div className="row border-0">
              ...
              <div className="col-lg-3 col-xs-12 links mb-3 border-0">
                ...
                <ul className="m-0 p-0">
                  ...
                  <li> <Link to="/addblog">Write Blog</Link></li>
              ...
              <div className="col-lg-4 col-xs-12 location border-0">
                ...
                <p className="mb-3"><i className="fa fa-phone me-3 mb-2"></i>(+91) 7660948870</p>
                <p><i className=" mb-0 pb-0 fa fa-envelope-o me-3"></i>mettaharikrishna@gmail.com</p>
              </div>
            </div>
